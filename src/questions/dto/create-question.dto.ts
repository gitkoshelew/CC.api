...
export class CreateQuestionDto {
  ...
  @ApiProperty({example: 'single / multi', description: 'how many of variables can been chosen for answer / required'})
  readonly type: QuestionTypes;
  @ApiProperty({example: 'light / medium / hard', description: 'set your difficulty / required'})
  ...
  @ApiProperty({example: 'React', description: 'topic of the question / required'})
